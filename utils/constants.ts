...
// Cumartesi 08:00 → yeni hafta görünür (admin düzenler, kullanıcı izler)
// Cumartesi 09:00 → yeni hafta tüm kullanıcılara açık

const TRANSITION_DAY = 6; // Cumartesi (0=Pazar, 6=Cumartesi)
const PREVIEW_HOUR = 8;   // Admin önizleme başlangıcı
const BOOKING_HOUR = 9;  // Kullanıcı randevu alma başlangıcı
 ...
 * - Cumartesi 09:00 öncesi: false
 * - Cumartesi 09:00 sonrası: true
 * - Pazar: true
 */
...
/**
 * Cumartesi 09:00'a kalan süreyi milisaniye olarak döndürür.
